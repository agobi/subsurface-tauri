...
<style>
  .dl { display: flex; flex-direction: column; font-size: 12px; width: max-content; min-width: 100%; }
  ...
  .dl :global(.loc) { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
</style>
