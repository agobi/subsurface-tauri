...
<style>
  .toolbar { height: 46px; flex: 0 0 46px; display: flex; align-items: center; gap: var(--space-2); padding: 0 var(--space-3); background: var(--panel); border-bottom: 1px solid var(--hair); }
